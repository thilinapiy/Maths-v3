 ...
 * oneWith.java
 *
 * Created on Jul 27, 2010, 1:56:54 PM
 */
 ...
 * @author tikky
 */
public class oneWith extends javax.swing.JFrame {
public int c=0,d=0;
int userinput=0;
private int ranValue1=(int)(Math.random()*100);
public int k=(int)(ranValue1%10);
public int l=(int)((Math.random()*1000)%(10-k));
public int ranValue2=k+l;
    /** Creates new form oneWith */
    public oneWith() {
        initComponents();
