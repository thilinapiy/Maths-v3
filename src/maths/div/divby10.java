 ...
 * @author tikky
 */
public class divby10 extends javax.swing.JFrame {
public int a=0,b=0,c=0,d=0;
private int ranValue1=(int)(Math.random()*10);
private int ranValue2 = ranValue1*10;
int userinput=0;
    ...
    */
    ...
    private void check() {
        ...
        int sec= 10;   // Integer.parseInt(jLabel3.getText());
        int actSum=fir/sec;
