 ...
 * @author tikky
 */
public class mulby3 extends javax.swing.JFrame {
...
int userinput=0;
    ...
    */
    ...
    private void check() {
        ...
        int sec= 3;   // Integer.parseInt(jLabel3.getText());
        int actSum=fir*sec;
