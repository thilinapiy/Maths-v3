 ...
 * by6.java
 *
 * Created on Sep 20, 2010, 2:46:27 PM
 */
 ...
 * @author home
 */
public class by6 extends javax.swing.JFrame {
      private int ranValue1=(int)((Math.random()*100));
public int a=0,b=0,c=0,d=0,e=0,f=0;
int userinput1=0 ;
int userinput2=0;

    /** Creates new form by6 */
    public by6() {
        initComponents();
        jLabel1.setText(Integer.toString(ranValue1));
       jLabel2.setText(Integer.toString(ranValue1+6));
       jLabel3.setText(Integer.toString(ranValue1+12));
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(500, 209));
   ...
   javax.swing.UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Iskoola Pota", 1, 24)));
        if ( fir==(userinput1-6)&& fir==(userinput2-12)){
