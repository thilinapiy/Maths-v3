 ...
 * by3.java
 *
 * Created on Sep 19, 2010, 4:58:34 PM
 */
 ...
 * @author kwc
 */
public class by3 extends javax.swing.JFrame {
    private int ranValue1=(int)((Math.random()*300));
public int a=0,b=0,c=0,d=0,e=0,f=0;
int userinput1=0 ;
int userinput2=0;

    /** Creates new form by3 */
    public by3() {
        initComponents();
       ...
       jLabel4.setText(Integer.toString(ranValue1+9));
    }
 ...
 private void check() {
        ...
        if ( fir==(userinput1-3)&& fir==(userinput2-6)){
