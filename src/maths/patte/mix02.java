 ...
 * mix02.java
 *
 * Created on Sep 19, 2010, 5:58:17 PM
 */
 ...
 * @author kwc
 */
public class mix02 extends javax.swing.JFrame {
...
int userinput2=0;
    ...
    /** Creates new form mix02 */
    public mix02() {
        initComponents();
         jLabel1.setText(Integer.toString(ranValue1));
       jLabel2.setText(Integer.toString(ranValue1-10));
       jLabel3.setText(Integer.toString(ranValue1-18));
       jLabel4.setText(Integer.toString(ranValue1-24));
   ...
   javax.swing.UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Iskoola Pota", 1, 24)));
        if ( fir==(userinput1+4)&& fir==(userinput2+6)){
