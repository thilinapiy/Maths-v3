 ...
 * mix03.java
 *
 * Created on Sep 20, 2010, 7:12:58 PM
 */
 ...
 * @author home
 */
public class mix03 extends javax.swing.JFrame {
     private int ranValue1=(int)((Math.random()*100)+100);

public int a=0,b=0,c=0,d=0,e=0,f=0;
int userinput1=0 ;
int userinput2=0;

    /** Creates new form mix03 */
    public mix03() {
        initComponents();
        jLabel1.setText(Integer.toString(ranValue1));
       jLabel2.setText(Integer.toString(ranValue1-3));
       jLabel3.setText(Integer.toString(ranValue1-9));
       jLabel4.setText(Integer.toString(ranValue1-18));
    }
 ...
 private void check() {
   ...
   javax.swing.UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Iskoola Pota", 1, 24)));
        if ( fir==(userinput1+12)&& fir==(userinput2+27)){
    ...
    private void setValues() {
          ranValue1=(int)((Math.random()*100)+100);
        jLabel1.setText(Integer.toString(ranValue1));
       jLabel2.setText(Integer.toString(ranValue1-3));
       jLabel3.setText(Integer.toString(ranValue1-9));
       jLabel4.setText(Integer.toString(ranValue1-18));
